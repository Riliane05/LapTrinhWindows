...
namespace Demo1
{
    public partial class FormTimekeeping : Form
    {
        private DemoDbContext db = new DemoDbContext();
        private Employee selectedEmployee;

        public FormTimekeeping()
        {
            InitializeComponent();

            dtpNgayChamCong.Value = DateTime.Today;
            dtpNgayChamCong.MaxDate = DateTime.Today;
            dtpNgayChamCong.MinDate = DateTime.Today;
            dtpNgayChamCong.Enabled = false; // hoặc dùng ReadOnly nếu muốn hiển thị nhưng không chỉnh
        ...
        private void btnCheckIn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Chỉ được chấm công trong ngày hôm nay!", "Thông báo");
                return;
            }
